...
internal static class Uncrustify
{
    ...
    [
        ...
        new("indent_with_tabs", "Indent With Tabs", SettingType.Integer, 0, Min: 0, Max: 2,
            Description: "0: spaces, 1: tabs to the brace level and spaces after, 2: tabs throughout", Group: "Layout"),
        new("indent_switch_case", "Indent Case Labels", SettingType.Integer, 4, Min: 0, Max: 16,
            Description: "Columns to indent case from its switch", Group: "Layout"),
        new("code_width", "Code Width", SettingType.Integer, 0, Min: 0, Max: 1000,
            Description: "Try to keep code within this many columns; 0 = off", Group: "Layout"),
        new("cmt_width", "Comment Width", SettingType.Integer, 0, Min: 0, Max: 256,
            Description: "Wrap comments at this column; 0 = off", Group: "Layout"),
        ...
        new("nl_max", "Maximum Consecutive Newlines", SettingType.Integer, 3, Min: 0, Max: 10,
            Description: "3 = at most two blank lines; 0 = no limit", Group: "Layout"),

        new("sp_arith", "Around Arithmetic Operators", SettingType.Choice, "force", Choices: Iarf,
            Description: "a + b", Group: "Spacing"),
        ...
        new("sp_bool", "Around Boolean Operators", SettingType.Choice, "force", Choices: Iarf,
            Description: "a && b", Group: "Spacing"),
        new("sp_after_comma", "After Comma", SettingType.Choice, "force", Choices: Iarf,
            Group: "Spacing"),
        ...
        new("align_assign_span", "Align Assignments", SettingType.Integer, 0, Min: 0, Max: 20,
            Description: "Align = over this many lines; 0 = off", Group: "Alignment"),
        new("align_right_cmt_span", "Align Trailing Comments", SettingType.Integer, 0, Min: 0, Max: 20,
            Description: "Align trailing comments over this many lines; 0 = off", Group: "Alignment"),

        new("mod_full_brace_if", "Braces On Single-Statement if", SettingType.Choice, "ignore", Choices: Iarf,
            Description: "add or remove braces around a one-line body", Group: "Code Changes"),
        new("mod_full_brace_for", "Braces On Single-Statement for", SettingType.Choice, "ignore", Choices: Iarf,
            Group: "Code Changes"),
        new("mod_full_brace_while", "Braces On Single-Statement while", SettingType.Choice, "ignore", Choices: Iarf,
            Group: "Code Changes"),
        new("mod_remove_extra_semicolon", "Remove Extra Semicolons", SettingType.Boolean, false,
            Group: "Code Changes"),
