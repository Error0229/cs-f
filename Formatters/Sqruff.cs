...
internal static class Sqruff
{
    ...
    [
        ...
        new(Rules, "Rules", SettingType.Choice, "core",
            ...
            Description: "layout: whitespace and line breaks only. all: also rewrites constructs, e.g. drops a redundant ELSE NULL"),
        ...
        new("sqruff:indentation/indented_joins", "Indent Joins", SettingType.Boolean, false,
            Description: "Indent JOIN under FROM", Group: "Layout"),
        new("sqruff:indentation/indented_ctes", "Indent CTEs", SettingType.Boolean, false,
            Group: "Layout"),
        new("sqruff:indentation/allow_implicit_indents", "Allow Implicit Indents", SettingType.Boolean, false,
            Description: "Allow WHERE a = 1 with an indented AND under it, instead of a break after WHERE", Group: "Layout"),
